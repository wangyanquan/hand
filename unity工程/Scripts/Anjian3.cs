...
public class Anjian3 : MonoBehaviour {
    ...
    void Awake()
    {
        myaudio = GameObject.Find("3").GetComponent<AudioSource>();
    ...
    void Update()
    {
        ...
        gameObject.transform.parent.position = new Vector3(-4.81f, 4, -3.471f);   //每次固定一下按钮，以免按键晃动
    }
