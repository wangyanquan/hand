...
public class Anjian6 : MonoBehaviour {
    ...
    void Awake()
    {
        myaudio = GameObject.Find("6").GetComponent<AudioSource>();
    ...
    void Update()
    {
        ...
        gameObject.transform.parent.position = new Vector3(-3.08f, 4, -3.471f);   //每次固定一下按钮，以免按键晃动
    }
